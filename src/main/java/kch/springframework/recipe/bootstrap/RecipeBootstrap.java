package kch.springframework.recipe.bootstrap;

import kch.springframework.recipe.domain.*;
import kch.springframework.recipe.repositories.CategoryRepository;
import kch.springframework.recipe.repositories.RecipeRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.setUrl("www.simplyrecipes.com/recipes/spicy_grilled_chicken_taco/");
